...
//java.lang패키지는 import문을 생략해도 자동으로 import된다. 
...
public class Hi {
	...
	public static void main(String[] args) {
		 ...
		 * %n : 줄바꿈
		 * */
		System.out.printf("제 이름은 %s 이고 제 나이는 %d 입니다%n","김철수",22);
		System.out.printf("제 평균 성적은 %f입니다\n", 95.33333);
		System.out.printf("제 평균 성적은 %.2f입니다\n", 95.3355);
		//소수점 이하 2째 자리까지 출력 (반올림)
		System.out.printf("%4d%n", 1);//4자리를 차지하고 1을 출력 
		System.out.printf("%4d%n", 10);//4자리를 차지하고 10을 출력 
		System.out.printf("%4d%n", 100);//4자리를 차지하고 100을 출력 
		//~를 사용하면 왼쪽 정렬이 된다 
		System.out.printf("%-4d%n", 1);//4자리를 차지하고 1을 출력 
		System.out.printf("%-4d%n", 10);//4자리를 차지하고 10을 출력 
		System.out.printf("%-4d%n", 100);//4자리를 차지하고 100을 출력 
